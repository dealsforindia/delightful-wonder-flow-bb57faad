...
export default defineTool({
  ...
  description:
    "Fuzzy-search the curated FMHY directory of 26,000+ free tools by name, section, category, or URL. Returns the top matches with their category, section, and URL.",
  inputSchema: {
