        ...
        {aiMode && (
          <div className="mb-4 flex items-center gap-2 border border-primary/40 bg-primary/5 px-4 py-2 text-[11px] text-primary">
            ...
            <span className="truncate">
              {aiLoading ? "Scanning 26,000+ tools for the best match…" : aiError ? aiError : `AI picked ${aiResults.length} tools for “${query.trim()}”`}
            </span>
          </div>
        )}
          ...
          >
            ...
            {recipeLoading && (
              <div className="space-y-3 p-6">
                ...
                <p className="pt-2 text-center text-[11px] text-muted-foreground">Composing a plan across 26,000+ tools…</p>
              </div>
            )}
